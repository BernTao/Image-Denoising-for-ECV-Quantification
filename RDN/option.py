...
def parser():
    ...
    # --- Apply ---
    parser.add_argument('--phase', default='test', help='phase of current script, train or test')
    parser.add_argument('--result_dir', default='/mnt/ctp_25/92_delay_denoise/05_rdn_result/pc_20230324/', help='result save directory')
    parser.add_argument('--overwrite', type=bool, default=False, help='whether overwrite existing results')
