...
class SaveData():
    def __init__(self, args):
        ...
        self.save_optimizer_path = os.path.join(self.checkpoint, 'optimizer')

    def create_checkpoint_dir(self):
        os.makedirs(self.checkpoint)
        os.makedirs(self.save_model_path)
        os.makedirs(self.save_optimizer_path)
    ...
    def save_model(self, model, optimizer, model_name):
        ...
        torch.save(optimizer.state_dict(), join(self.save_optimizer_path, model_name))
