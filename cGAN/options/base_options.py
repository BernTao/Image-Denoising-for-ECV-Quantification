...
import cGAN.data as data
import cGAN.models as models
from cGAN.util import util
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='cGAN/output/checkpoints/', help='models are saved here')
        # model parameters
        ...
        parser.add_argument('--num_threads', default=64, type=int, help='# threads for loading data')
